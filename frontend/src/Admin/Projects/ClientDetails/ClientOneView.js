...
const [data,setData] = useState([])
  ...
  const decryptedProjectDatay = CryptoJS.AES.decrypt(encryptedProjectData, "clientsecretKey").toString(CryptoJS.enc.Utf8);
...
//   console.log(projectStatusData);
 ...
 <div className="project-details">
            <div className="project-content-box">
              ...
              <div className="project-matter">
                <label><strong>EMPLOYEE ALLOTED: </strong></label>
              ...
              <div className="project-matter">
                <label><strong>EMPLOYEE DESIGNATION: </strong></label>
